# ⚡ ESP32 Real-Time 10-Band I2S Audio DSP Parametric & Graphic Equalizer
...
High-fidelity digital signal processor reading stereo 24-bit/48kHz I2S audio, calculating 10-band biquad IIR filters in parallel, with web UI curve manipulation.
...
3. Pastikan dependensi pustaka terpasang via Library Manager:
   ...
   * `Wire` & `SPI`
   * `Preferences`
4. Buka berkas [`esp32-i2s-dsp-graphic-equalizer.ino`](./esp32-i2s-dsp-graphic-equalizer.ino).
